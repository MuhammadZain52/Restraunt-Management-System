...
public class DashboardFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_dashboard_faaah, container, false);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.item_dashboaard) {
            ...
            Intent i = new Intent(getActivity(), FAAAHMainActivity.class);
            getActivity().startActivity(i);
        } else if (item.getItemId() == R.id.back_home) {
            Intent i = new Intent(getActivity(), FAAAHListActivity.class);
            getActivity().startActivity(i);
        }
        return true;
    }
